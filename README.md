...
- Go to the [Webhooks](#webhooks) section in the [Mux Dashboard](https://dashboard.mux.com/login) and use the https://smee.io/{CUSTOM_UNIQUE_NAME} as the "URL to notify"
